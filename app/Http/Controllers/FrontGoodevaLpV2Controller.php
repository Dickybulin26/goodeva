...
class FrontGoodevaLpV2Controller extends Controller

{
    ...
    $text_lang = [
      'english' => [
        'section1' => [
          ...
          'description' => 'Goodeva is pioneer of fatigue management systems in Indonesia. Our system is powered by advanced technology including artificial intelligence & iOT wearables Automation.',
          'text1' => 'Start Trial',
          'text2' => 'Whatsapp Us',
        ],
        'section2' => [
        ...
        'section3' => [
          ...
          'title_m' => 'Realize Zero Incident Fatigue With iOT & Ai Goodeva',
        ...
        'section4' => [
          ...
          'image' => 'image-fatigue-management.webp',
        ],
        'section5' => [
          'title' => 'Predict Fatigue. Intervene. <br> Get a 360º View of Fatigue Risk.',
          'title_m' => 'Predict Fatigue. Intervene. Get a 360º View of Fatigue Risk.',
          ...
          'image' => 'image-predict-fatigue_1.webp',
        ],
        'section6' => [
          'name_product' => 'Dashboard Smart Safety',
          'title' => 'Open API, Customized, & Integrated Third-Party',
          'title_m' => 'Open API, Customized, & Integrated Third-Party',
        ...
        'section7' => [
          ...
          'feature_product' => [
            'content1' => [
              'cover' => "smart-safety-sleep-monitoring.webp",
        ...
        'section8' => [
          ...
          'list_cover' => [
            'image-5-reason-smart-safety.webp',
            'image-5-reason-smart-safety.webp',
            'image-5-reason-smart-safety.webp',
            'image-5-reason-smart-safety.webp',
            'image-5-reason-smart-safety.webp',
        ...
        'section9' => [
          ...
          'image' => 'image-why-smart-safety-update1.webp',
          'image_m' => 'image-why-smart-safety-mobile.webp',
        ],
        'section10' => [
          ...
          'text1_m' => 'Smart safety has been proven in various regions in Indonesia to help companies prevent work accidents towards zero incidents with the help of technology.',
          'image' => 'image-why-smart-safety-update1.webp',
          'list_implement' => [
            'location1' => [
      ...
      'english' => [
        ...
        'section3' => [
          ...
          'list_content' => [
            ...
            'Transparant Project Timeline',
            'Fast & On Time',
            'On Budget Price',
            'First hand & has a team',
          ],
          // 'list_content' => [
  ...
  public function career()
  {
        ...
        'section3' => [
          ...
          'list_job' => [
            ...
            'job2' => [
              ...
              'position' => 'web programmer',
              'location' => 'Bekasi, Indonesia',
              'icon' => 'goodeva-it-support-v2.png',
            ],
            'job3' => [
              'status' => 'Full Time',
    ...
    return view('front-goodeva-lp/goodeva-career-v2', compact(
      'text_lang',
      'default_lang',
    ));
  }
  ...
  public function careerV2_2()
  {
        ...
        'section3' => [
          ...
          'list_job' => [
            1 => [
              ...
              'location' => 'Bekasi, Indonesia',
              'icon' => 'goodeva-it-support-v2.png',
              // 'link' => 'https://mail.google.com/mail/?view=cm&fs=1&to=recruitment@goodeva.co.id&cc=ignas@goodeva.co.id&su={{ $textSubject }}&body={{ $textBody }}',
              'link' => 'https://forms.gle/feVZnaG4Fc9p5aMH6',
            ],
            [
              'status' => 'Full Time',
              'position' => 'Web Programmer (Laravel)',
              'location' => 'Bekasi, Indonesia',
              'icon' => 'goodeva-it-support-v2.png',
              // 'link' => 'https://mail.google.com/mail/?view=cm&fs=1&to=recruitment@goodeva.co.id&cc=ignas@goodeva.co.id&su={{ $textSubject }}&body={{ $textBody }}',
              'link' => 'https://forms.gle/TN9cF2MWSBaHWcv6A',
            ],
            [
              'status' => 'Full Time',
              'position' => 'Mobile Programmer (React Native)',
              'location' => 'Bekasi, Indonesia',
              'icon' => 'goodeva-it-support.png?v=1',
              // 'link' => 'https://mail.google.com/mail/?view=cm&fs=1&to=recruitment@goodeva.co.id&cc=ignas@goodeva.co.id&su={{ $textSubject }}&body={{ $textBody }}',
              'link' => 'https://forms.gle/qamQ1wYgQ2ihrseM9',
            ],
            [
              'status' => 'Full Time',
              'position' => 'Mobile Android Programmer',
              'location' => 'Bekasi, Indonesia',
              'icon' => 'goodeva-it-support.png?v=1',
              // 'link' => 'https://mail.google.com/mail/?view=cm&fs=1&to=recruitment@goodeva.co.id&cc=ignas@goodeva.co.id&su={{ $textSubject }}&body={{ $textBody }}',
              'link' => 'https://forms.gle/X5JHXyDvWtjuzXZG9',
            ],
            [
              'status' => 'Full Time',
              'position' => 'Fullstack Programmer',
              ...
              'icon' => 'goodeva-engineering.png',
              // 'link' => 'https://mail.google.com/mail/?view=cm&fs=1&to=recruitment@goodeva.co.id&cc=ignas@goodeva.co.id&su={{ $textSubject }}&body={{ $textBody }}',
              'link' => ' https://forms.gle/ym3AFQcLGrxRc1Lq9',
            ],
            [
              'status' => 'Full Time',
              ...
              'icon' => 'goodeva-business-development.png',
              // 'link' => 'https://mail.google.com/mail/?view=cm&fs=1&to=recruitment@goodeva.co.id&cc=ignas@goodeva.co.id&su={{ $textSubject }}&body={{ $textBody }}',
              'link' => 'https://forms.gle/LowEdH7d2YyantK3A',
            ],
            [
              'status' => 'Full Time',
              ...
              'icon' => 'goodeva-marketing-creative.png',
              // 'link' => 'https://mail.google.com/mail/?view=cm&fs=1&to=recruitment@goodeva.co.id&cc=ignas@goodeva.co.id&su={{ $textSubject }}&body={{ $textBody }}',
              'link' => 'https://forms.gle/PU9N74G3TKktwngH7',
            ],
            [
              'status' => 'Full Time',
              'position' => 'IT Support After Sales',
              'location' => 'Bekasi, Indonesia',
              'icon' => 'goodeva-design-graphic.png',
              // 'link' => 'https://mail.google.com/mail/?view=cm&fs=1&to=recruitment@goodeva.co.id&cc=ignas@goodeva.co.id&su={{ $textSubject }}&body={{ $textBody }}',
              'link' => 'https://forms.gle/88ArwE2rUj7FqiTL7
              ',
            ],
            [
              'status' => 'Full Time',
              ...
              'icon' => 'goodeva-data-analytics.png',
              // 'link' => 'https://mail.google.com/mail/?view=cm&fs=1&to=recruitment@goodeva.co.id&cc=ignas@goodeva.co.id&su={{ $textSubject }}&body={{ $textBody }}',
              'link' => ' https://forms.gle/4Fo4TD4fZV9yGVwLA ',
            ],
            [
              'status' => 'Full Time',
              'position' => 'HRGA',
              ...
              'icon' => 'goodeva-business-development.png',
              // 'link' => 'https://mail.google.com/mail/?view=cm&fs=1&to=recruitment@goodeva.co.id&cc=ignas@goodeva.co.id&su={{ $textSubject }}&body={{ $textBody }}',
              'link' => ' https://forms.gle/ey7XuyM8Z2YetEGN7',
            ],
          ],
        ],
        'section4' => [
          ...
          'card1' => [
            ...
            'address' => 'Goodeva building 1, Grand Galaxy Commercial, Blok RSK 6/15 Jalan Boulevar Raya Timur, Kota Bekasi.',
            // 'contact' => 'WhatsApp : <br> 081222-666-196',
            'contact' => 'WhatsApp : <br> <a href="//wa.me/+6287778291924" target=_blank>+62 877‑7829‑1924</a>',
            'email' => 'email  : sales@goodeva.co.id',
          ],
          'card2' => [
            'name' => 'Goodeva Office 2',
    ...
    return view('front-goodeva-lp/goodeva-career-v2_2', compact(
      'text_lang',
      'default_lang',
    ));
  }
