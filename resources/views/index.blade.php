        ...
        <section id="watch-video" class="watch-video">
            <div class="container justify-content-center text-center aos-init aos-animate" data-aos="fade-up"
                ...
                <div class="section-title">
                    ...
                    <p>Our flagship platform adopt artificial intelligence to serve better experience and help your business
                        go
                        beyond innovation</p>
                </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 text-container">
                        ...
                        <p class="mb-4">
                            Platform for safety + fatigue monitoring, Empowering artificial intelligence to Improve Safety,
                            Efficiency
                            and avoid accidents
                        </p>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6 text-product">
                        ...
                        <p class="mb-4">
                            Salestrace helps business increase their sales performance by adopting AI to drive sales growth
                            and cost
                            savings
                        </p>
                        <a href="#" class="btn-learn-more scrollto">Learn More</a>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 pt-4 pt-lg-0 text-container">
                        ...
                        <p class="mb-4">
                            Handcraft Technology development services. optimize business process, systems and solutions for
                            enterprise
                            client.
                        </p>
                        <a href="#" class="btn-learn-more scrollto">Learn More</a>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6 col-xs-12  text-feedback">
                        <p class="client-testimoni mb-4">
                            "Goodeva has been proven to significantly reduce the number of workplace accidents and increase
                            employee
                            productivity."
                        </p>
                        <span class="client-name">Iwan Gunawan</span>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-2 col-md-3 col-sm-4 col-4 d-flex align-items-center mb-3">
                        <div class="logo-liputan">
                            <img class="img-fluid" src="assets/img/liputan/tempo.png" alt="logo media">
                        </div>
                    </div>

                    <div class="col-lg-2 col-md-3 col-sm-4 col-4 d-flex align-items-center mb-3 d-md-block">
                        <div class="logo-liputan">
                            <img class="img-fluid" src="assets/img/liputan/Liputan 6.png" alt="logo media">
                        </div>
                    </div>

                    <div class="col-lg-2 col-md-3 col-sm-4 col-4 d-flex align-items-center mb-3">
                        <div class="logo-liputan">
                            <img class="img-fluid" src="assets/img/liputan/tirtoid.png" alt="logo media">
                        </div>
                    </div>

                    <div class="col-lg-2 col-md-3 col-sm-4 col-4 d-flex align-items-center mb-3 d-md-block">
                        <div class="logo-liputan">
                            <img class="img-fluid" src="assets/img/liputan/tribunnews.png" alt="logo media">
                        </div>
                    </div>

                    <div class="col-lg-2 col-md-3 col-sm-4 col-4 d-flex align-items-center mb-3 ">
                        <div class="logo-liputan">
                            <img class="img-fluid" src="assets/img/liputan/bisniscom.png" alt="logo media">
                        </div>
                    </div>

                    <div class="col-lg-2 col-md-3 col-sm-4 col-4 d-flex align-items-center mb-3 d-md-block">
                        <div class="logo-liputan">
                            <img class="img-fluid" src="assets/img/liputan/beritasatu.png" alt="logo media">
                        </div>
                    </div>
