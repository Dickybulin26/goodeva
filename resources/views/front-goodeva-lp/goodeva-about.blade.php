...
<style>
  ...
  .aslide-area .slid-content,
  .aslide-ceo-area .slid-content {
  ...
  @media screen and (min-width: 1000px) and (max-width: 1098px) {
    ...
    .timeline-area .milestone.s1 img,
    .timeline-area .milestone.s2 img,
    .timeline-area .milestone.s3 img,
    .timeline-area .milestone.s4 img,
    .timeline-area .milestone.s5 img {
        ...
        <div class="section-heading mb-2">
          ...
          <div class="heading-text">
            ...
            <p>
              ...
              <?php echo $text_lang[$default_lang]['section1']['text1'] ?>
    ...
    <div class="row mx-0">
      ...
      <div class="col-md-12 text-center pb-5">
        ...
        <div class="title--journey mb-3 px-5">
          ...
          <p><?php echo $text_lang[$default_lang]['section2']['title'] ?></p>
        ...
        <div class="deskripsi--journey px-4">
          ...
          <p class="desktop-show">
            ...
            <?php echo $text_lang[$default_lang]['section2']['text1'] ?>
            ...
            <div class="col-md-6 col-sm-6">
              ...
              <div class="milestone s1">
                ...
                <div class="year">
                  ...
                  <button class="btn">{{ $text_lang[$default_lang]['section2']['timeline1']['year'] }}</button>

                </div>

                <div class="story">

                  {{ $text_lang[$default_lang]['section2']['timeline1']['text'] }}
            ...
            <div class="col-md-6 col-sm-6">
              ...
              <div class="milestone s2">
                ...
                <div class="year">
                  ...
                  <button class="btn">{{ $text_lang[$default_lang]['section2']['timeline2']['year'] }}</button>

                </div>

                <div class="story">

                  {{ $text_lang[$default_lang]['section2']['timeline2']['text'] }}
            ...
            <div class="col-md-6 col-sm-6">
              ...
              <div class="milestone s3">
                ...
                <div class="year">
                  ...
                  <button class="btn">{{ $text_lang[$default_lang]['section2']['timeline3']['year'] }}</button>

                </div>

                <div class="story">

                  {{ $text_lang[$default_lang]['section2']['timeline3']['text'] }}
            ...
            <div class="col-md-6 col-sm-6">
              ...
              <div class="milestone s4">
                ...
                <div class="year">
                  ...
                  <button class="btn">{{ $text_lang[$default_lang]['section2']['timeline4']['year'] }}</button>

                </div>

                <div class="story">

                  {{ $text_lang[$default_lang]['section2']['timeline4']['text'] }}
            ...
            <div class="col-md-6 col-sm-6">
              ...
              <div class="milestone s5">
                ...
                <div class="year">
                  ...
                  <button class="btn">{{ $text_lang[$default_lang]['section2']['timeline5']['year'] }}</button>

                </div>

                <div class="story">

                  {{ $text_lang[$default_lang]['section2']['timeline5']['text'] }}
    ...
    <div class="row mx-0">
      ...
      <div class="col-md-12 text-center pt-3 pb-3 mt-5">
        ...
        <div class="title--journey mb-0 mt-3 pt-5 px-5">
          ...
          <p class="mb-0"><?php echo $text_lang[$default_lang]['section2']['title'] ?></p>
      ...
      <div class="row my-5">
        ...
        <div class="col-md-12">
          ...
          <div class="visi-misi--title">
            ...
            <p class="text-white"><strong>{{ $text_lang[$default_lang]['section3']['title'] }}</strong></p>
      ...
      <div class="row my-5">
          ...
          <div class="row">
            <div class="col-md-12 col-lg-12">
              ...
              <div class="visi-misi--title">
                ...
                <p><strong>{{ $text_lang[$default_lang]['section4']['content1']['title'] }}</strong></p>

              </div>

              <div class="main-core">
                @for($i_main = 0; $i_main < count($text_lang[$default_lang]['section4']['content1']['main_point']); $i_main++) <!-- separator when format document -->
                  <span class="content">{{ $text_lang[$default_lang]['section4']['content1']['main_point'][$i_main] }}</span>
                  @endfor
              </div>

              <p class="visi-misi--desc">

                <?php echo $text_lang[$default_lang]['section4']['content1']['text1'] ?>
            ...
            <div class="col-md-12 col-lg-12">
              <div class="visi-misi--title">
                ...
                <p><strong>{{ $text_lang[$default_lang]['section4']['content2']['title'] }}</strong></p>

              </div>

              <p class="visi-misi--desc">

                {{ $text_lang[$default_lang]['section4']['content2']['text1'] }}
        ...
        <div class="col-md-6 col-sm-6">
          ...
          <div class="visi-misi--title">
            ...
            {{ $text_lang[$default_lang]['section4']['content3']['title'] }}

          </div>

          <div class="row">

            @for($i_mission = 0; $i_mission < count($text_lang[$default_lang]['section4']['content3']['list_mission']); $i_mission++) <!-- separator when format document -->
              <div class="col-md-12 col-sm-12 p-2 text-value">
                <div class="col-md-1 col-lg-1">
                  <i class="fa fa-circle bg--point-circle bg--visi--point"></i>
                </div>
                <div class="col-md-11 col-lg-11">
                  <span>{{ $text_lang[$default_lang]['section4']['content3']['list_mission'][$i_mission] }}</span>
                </div>
              </div>
              @endfor

              <!-- <div class="col-md-12 col-sm-12 p-2 text-value"><i class="fa fa-circle bg--point-circle bg--visi--point"></i> <span>Lifetime Guarantee</span></div> -->
              <!-- <div class="col-md-12 col-sm-12 p-2 text-value"><i class="fa fa-circle bg--point-circle bg--visi--point"></i> <span>Fully Maintenance</span></div> -->
              <!-- <div class="col-md-12 col-sm-12 p-2 text-value"><i class="fa fa-circle bg--point-circle bg--visi--point"></i> <span>Daily Support</span></div> -->
...
<!--./section comment -->
<!-- end section core value desktop -->

<!-- section core value mobile -->
      ...
      <div class="row mx-0">
        ...
        <div class="col-md-7 col-xs-12">
          ...
          <div class="visi-misi--title">
            ...
            <p><strong>{{ $text_lang[$default_lang]['section4']['content3']['title'] }}</strong></p>
          ...
          <div class="px-2">
            ...
            <div class="row">
              ...
              <div class="col-md-10 misi--point py-2 px-0 visi-misi--desc col-xs-11">{{ $text_lang[$default_lang]['section4']['content3']['list_mission'][$i_mission] }}</div>
...
<!--./section comment -->
<!-- end section core value mobile -->



<section class="section-comments bg-greyeb pb-0 pt-0 desktop-show d-none">
...
<section class="section-comments bg-greyeb pb-0 pt-0 mobile-show d-none">
  ...
  <div class="container my-5">
    ...
    <div class="row mt-4 mb-3">
      ...
      <div class="col-md-12 text-center">
        ...
        <div class="title--rekrut">{{ $text_lang[$default_lang]['section8']['title'] }}</div>

        <p>{{ $text_lang[$default_lang]['section8']['text1'] }}</p>
    ...
    <div class="row mb-4">
      ...
      <div class="col-md-12 text-center">
        ...
        <a href="{{ url('careers')}}" class="btn btn-lihat-lowongan">

          <span>{{ $text_lang[$default_lang]['section8']['text2'] }}</span>
