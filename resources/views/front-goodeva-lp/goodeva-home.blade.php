...
<section class="header" id="header">
  ...
  <div class="slider-area desktop-show mt-3">
    ...
    <div class="hslide-area d-none d-sm-block" id="hslide-area">
      ...
      <!-- slide pertama -->
      @for($i_slider = 1; $i_slider <= count($text_lang[$default_lang]['section1']['list_slider']); $i_slider++) <!-- comment separator -->
        @if($i_slider <=2) <!-- comment separator -->
          <div class="slid-content" style="background-color: #3A5664 !important;">

            <img src="{{asset('public/img/assets/home/slider/'.$text_lang[$default_lang]['section1']['list_slider']['slider'.$i_slider]['img_first'])}}" class="d-block {{ $i_slider != 2 ? 'w-100' : '' }}" alt="">

            <div class=" col-md-6 col-sm-8 txt-header-right">

              <span>{{ $text_lang[$default_lang]['section1']['list_slider']['slider'.$i_slider]['text1'] }}</span>

              <h2>{{ $text_lang[$default_lang]['section1']['list_slider']['slider'.$i_slider]['text2'] }}</h2>

              <p>{{ $text_lang[$default_lang]['section1']['list_slider']['slider'.$i_slider]['text3'] }}</p>

              <a href="{{url('contact')}}" class="btn btn-started-header">

                <span>{{ $text_lang[$default_lang]['section1']['list_slider']['slider'.$i_slider]['text_button'] }}</span>
          ...
          <div class="slid-content">
            ...
            <img src="{{ asset('public/img/assets/home/slider/'.$text_lang[$default_lang]['section1']['list_slider']['slider'.$i_slider]['img_first']) }}" class="d-block w-100" alt="">

            <img src="{{ asset('public/img/assets/home/slider/'.$text_lang[$default_lang]['section1']['list_slider']['slider'.$i_slider]['img_second']) }}" class="img-left-worker" alt="">
  ...
  <div class="slider-area mobile-show mt-0">
    ...
    <div class="hslide-area d-none d-sm-block" id="hslide-area-mobile">
      ...
      <div class="slid-content">
        ...
        <img src="{{asset('public/img/assets/home/slider/Goodeva-b2b-integrated-health-safety-technology-responsive-1.jpg')}}" class="d-block w-100" alt="">
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-6 px-5 py-5">
        <img src="{{ asset('public/img/assets/home/updated_asset/'.$text_lang[$default_lang]['section2']['about_product']['content1']['cover']) }}" class="img-section " alt="">
      </div>
      <div class="col-md-6 px-5 py-5">
        <img src="{{asset('public/img/assets/home/updated_asset/'.$text_lang[$default_lang]['section2']['about_product']['content1']['logo'])}}" class="img-responsive" alt="">
        <h4 class="fitur-title">{{ $text_lang[$default_lang]['section2']['about_product']['content1']['main_text'] }}</h4>
        <p class="fitur-desc">
          {{ $text_lang[$default_lang]['section2']['about_product']['content1']['sub_text'] }}
        </p>
        <br>
        <a href="{{ url('goodeva-smart-safety') }}" class="btn-wa px-3 py-2">
    ...
    <div class="row">
      ...
      <div class="col-md-6 px-5 py-5">
        <img src="{{asset('public/img/assets/home/updated_asset/'.$text_lang[$default_lang]['section2']['about_product']['content2']['logo'])}}" class="img-responsive" alt="">
        <h4 class="fitur-title">{{ $text_lang[$default_lang]['section2']['about_product']['content2']['main_text'] }}</h4>
        <p class="fitur-desc">
          {{ $text_lang[$default_lang]['section2']['about_product']['content2']['sub_text'] }}
        </p>
        <br>
        <a href="{{ url('goodeva-omsetku') }}" class="btn-wa px-3 py-2">
          {{ $text_lang[$default_lang]['section2']['about_product']['content2']['button_text'] }}
        </a>
      </div>

      <div class="col-md-6 px-5 py-5">
        <img src="{{ asset('public/img/assets/home/updated_asset/'.$text_lang[$default_lang]['section2']['about_product']['content2']['cover']) }}" class="img-section " alt="">
      </div>
...
<section class="fitur mt-0 mb-0 atas-rounded mobile-show" id="fitur">
  ...
  <div class="container">
    ...
    <div class="row mx-0 my-4 px-3">
      ...
      <div class="col-md-4 box-fitur my-fitur mx-0" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="1000" data-aos-once="true">

        <img src="{{asset('public/img/assets/home/safety kotak@2x.png')}}" class="img-responsive" alt="">
        ...
        <div class="mt-5-custom">
          <img src="{{asset('public/img/assets/home/updated_asset/Group 18470.png')}}" style="width: 100% !important; height: auto !important;" alt="">
        </div>


        <p>{{ $text_lang[$default_lang]['section2']['about_product']['content1']['sub_text'] }}</p>
      ...
      <div class="col-md-4 box-fitur my-fitur mx-0" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="500" data-aos-once="true">

        <img src="{{asset('public/img/assets/home/logo-omsetku-m.png')}}" class="img-responsive" alt="">
        ...
        <div class="mt-5-custom">
          <img src="{{asset('public/img/assets/home/updated_asset/'.$text_lang[$default_lang]['section2']['about_product']['content2']['cover'])}}" style="width: 100% !important; height: auto !important;" alt="">
        </div>

        <p>{{ $text_lang[$default_lang]['section2']['about_product']['content2']['sub_text'] }}</p>
    ...
    <div class="row">
      ...
      <div class="col-lg-5 col-md-5 col-sm-6 col-md-offset-1">
        ...
        <div class="card-safety rounded-w-bg h-box-f text-center p-4">
          ...
          <span class="text-judul">{{ $text_lang[$default_lang]['section2']['card_info']['card1']['title'] }}</span>

          <p><?php echo $text_lang[$default_lang]['section2']['card_info']['card1']['description'] ?></p>

          <a href="{{url('goodeva-smart-safety')}}" class="btn btn-lihat-detail transition-content">

            <span>{{ $text_lang[$default_lang]['section2']['card_info']['card1']['button_text'] }}</span>

            <i class="fa fa-chevron-right"></i>

          </a>

          <img src="{{asset('public/img/assets/home/'.$text_lang[$default_lang]['section2']['card_info']['card1']['cover'])}}" alt="" class="img-character" style="width: 70%; margin-right: -39px;">
      ...
      <div class="col-lg-5 col-md-5 col-sm-6">
        ...
        <div class="card-safety rounded-w-bg h-box-f text-center p-4">
          ...
          <span class="text-judul">{{ $text_lang[$default_lang]['section2']['card_info']['card2']['title'] }}</span>

          <p><?php echo $text_lang[$default_lang]['section2']['card_info']['card2']['description'] ?></p>

          <a href="{{ url('goodeva-omsetku') }}" class="btn btn-lihat-detail transition-content">

            <span>{{ $text_lang[$default_lang]['section2']['card_info']['card2']['button_text'] }}</span>

            <i class="fa fa-chevron-right"></i>

          </a>

          <img src="{{ asset('public/img/assets/home/'.$text_lang[$default_lang]['section2']['card_info']['card2']['cover']) }}" alt="">
      ...
      <div class="col-md-10 col-lg-10 col-sm-12 col-md-offset-1 mt-5">
        ...
        <div class="card-erp rounded-w-bg h-box-l text-left p-4 pl-5">
          ...
          <span class="text-judul">{{ $text_lang[$default_lang]['section2']['card_info']['card3']['title'] }}</span>

          <p><?php echo $text_lang[$default_lang]['section2']['card_info']['card3']['description'] ?></p>

          <a href="{{ url('solutions') }}" class="btn btn-lihat-detail transition-content">

            <span>{{ $text_lang[$default_lang]['section2']['card_info']['card3']['button_text'] }}</span>

            <i class="fa fa-chevron-right"></i>

          </a>

          <img src="{{ asset('public/img/assets/home/'.$text_lang[$default_lang]['section2']['card_info']['card3']['cover']) }}" alt="">
        ...
        <div class="hslide-area d-none d-sm-block" id="infocard_slider">
          ...
          <div class="slid-content">
            ...
            <div class="card-safety rounded-w-bg h-box-f mx-2 mx-360p-2 text-center p-4">
              ...
              <img src="{{asset('public/img/assets/home/'.$text_lang[$default_lang]['section2']['card_info']['card1']['cover'])}}" class="char--info-img" alt="">
          ...
          <div class="slid-content">
            ...
            <div class="card-safety rounded-w-bg h-box-f mx-2 mx-360p-2 text-center p-4">
              ...
              <span class="text-judul">{{ $text_lang[$default_lang]['section2']['card_info']['card2']['button_text'] }}</span>

              <p><?php echo $text_lang[$default_lang]['section2']['card_info']['card2']['description'] ?></p>

              <a href="{{ url('goodeva-omsetku') }}" class="btn btn-lihat-detail">
              ...
              <img src="{{asset('public/img/assets/home/'.$text_lang[$default_lang]['section2']['card_info']['card2']['cover'])}}" class="char--info-img" alt="">
          ...
          <div class="slid-content">
            ...
            <div class="card-safety rounded-w-bg h-box-f mx-2 mx-360p-2 text-center p-4">
              ...
              <span class="text-judul">{{ $text_lang[$default_lang]['section2']['card_info']['card3']['button_text'] }}</span>
              ...
              <img src="{{asset('public/img/assets/home/'.$text_lang[$default_lang]['section2']['card_info']['card3']['cover'])}}" class="char--info-img" alt="">
...
<section class="section-compannies portfolio bg-port pt-6rem pb-6rem pt-sm-1-5rem" id="portfolio">
  ...
  <div class="p-5px-mobile">
    ...
    <div class="header text-center">
      ...
      <h4 class="mt-0 mb-5">{{ $text_lang[$default_lang]['section3']['title'] }}</h4>
  ...
  <div class="testimoni-h desktop-show">
    ...
    @for($i_klien = 1; $i_klien <= count($text_lang[$default_lang]['section3']['state_klien']); $i_klien++) <!-- comment separator -->
      <div>
        <div class="testimoni">
          ...
          <div class="row">
            ...
            <div class="col-md-5 col-5 col-md-offset-1 lay">
              ...
              <div class="box-box shadow">
                ...
                <div class="col-md-12 img-customer">
                  ...
                  <img class="img-fluid" style="width: 40px;" src="{{ asset('public/img/assets/home/'.$text_lang[$default_lang]['section3']['state_klien']['state'.$i_klien]['logo_company']) }}" alt="">

                </div>

                <div class="col-md-12">

                  <h4>{{ $text_lang[$default_lang]['section3']['state_klien']['state'.$i_klien]['statement'] }}</h4>

                  <span>{{ $text_lang[$default_lang]['section3']['state_klien']['state'.$i_klien]['name'] }}</span>

                  <p class="p-putih">{{ $text_lang[$default_lang]['section3']['state_klien']['state'.$i_klien]['klien_from'] }}</p>
            ...
            <div class="col-md-4 col-4">
              ...
              <img class="max-img hid" style="/*filter: brightness(0.70);" src="{{ asset('public/img/assets/home/'.$text_lang[$default_lang]['section3']['state_klien']['state'.$i_klien]['picture']) }}" alt="">
                ...
                <div class="col-md-12">
                  ...
                  <div class="row mx-0">
                    <div class="col-xs-4 col-sm-4 pl-0">
                      <img src="{{asset('public/img/assets/home/'.$text_lang[$default_lang]['section3']['state_klien']['state'.$i_klien]['logo_company'])}}" alt="">
                    </div>
                    <div class="col-xs-8 col-sm-8 px-0">
                      <span>{{ $text_lang[$default_lang]['section3']['state_klien']['state'.$i_klien]['name'] }}</span>
                      <br>
                      <span class="p-putih">{{ $text_lang[$default_lang]['section3']['state_klien']['state'.$i_klien]['klien_from'] }}</span>
                    </div>
                  </div>
...
<section class="section-compannies liputan" id="liputan">
  ...
  <div class="header text-center">
    ...
    <h4 class="mt-2 mobile-show mb-2">{{ $text_lang[$default_lang]['section4']['title'] }}</h4>
