          ...
          <div class="block b-radius10px border-2px">
            ...
            <div class="row mx-0">
              ...
              <div class="col-md-12 col-lg-12 pb-2 px-0 dsp-flex">
                <span class="time-job">{{ $text_lang[$default_lang]['section3']['list_job']['job'.$i_job]['status'] }}</span>
              </div>

              <div class="col-md-12">

                <img src="{{ asset('public/img/assets/career/'.$text_lang[$default_lang]['section3']['list_job']['job'.$i_job]['icon']) }}" class="box-img" alt="">
              ...
              <div class="col-md-12 pt-2 px-2">
                ...
                <p class="title">{{ $text_lang[$default_lang]['section3']['list_job']['job'.$i_job]['position'] }}</p>

                <span>
                  <img src="{{ url('public/asset-goodeva-lp/marker/pin-location.png') }}" alt="" srcset="" class="icon-pin">
                  {{ $text_lang[$default_lang]['section3']['list_job']['job'.$i_job]['location'] }}
                </span>
                ...
                <div class="row">
                  <div class="col-md-12 col-lg-12 py-3">
                    <button class="button-blue">
                      <?
                      $textSubject = "Apply_".$text_lang[$default_lang]['section3']['list_job']['job'.$i_job]['position']."_Goodeva";
                      $textBody = "Hallo kandidat goodeva ninja, %0D%0A %0D%0A Mohon lengkapi data di bawah ini! %0D%0A %0D%0A Nama : %0D%0A Domisili : %0D%0A Posisi yang di lamar : ".$text_lang[$default_lang]['section3']['list_job']['job'.$i_job]['position']." %0D%0A %0D%0A Mohon silakan cantumkan CV dan portofolio dibawah ini!";
                      ?>
                      <!-- <a class="text-white" style="text-decoration: none;" href="https://www.linkedin.com/company/goodeva-technology/"> -->
                      <a class="text-white" style="text-decoration: none;" target="_blank" href="https://mail.google.com/mail/?view=cm&fs=1&to=recruitment@goodeva.co.id&cc=ignas@goodeva.co.id&su={{ $textSubject }}&body={{ $textBody }}">
                        <!-- <a class="text-white" style="text-decoration: none;" href="mailto:mrivaldi2543@gmail.com?cc=mrivaldi2543@gmail.com, mrivaldi2543@gmail.com, &bcc=mrivaldi2543@gmail.com&subject=Recruitment Goodeva"> -->
                        Apply now
                      </a>
                    </button>
                  </div>
