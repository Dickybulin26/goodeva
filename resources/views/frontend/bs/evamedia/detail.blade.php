                ...
                <div class="row">
                    <div class="col-md-7 offset-md-3" id="hero-content-area">
                        <div class="news-head-info" id="news-head-info">
                            {{-- <h1 class="news-head-title">The Trouble With Teachability</h1> --}}
                            {{-- <h3 class="news-head-desc">Why solving for what’s easily explained winds up making things hard</h3> --}}
                            {{-- <h3 class="news-head-author">Jane Elliott PhD</h3> --}}
                            {{-- <p class="news-head-date">
                                published in <span class="news-head-publisher">Better Humans</span> • 06 Oct • 1 day ago
                            </p> --}}
            ...
            <div class="row">
                <div class="col-md-7 offset-md-3">
                    <div class="evamedia-news-content-area" id="evamedia-news-content-area">
                        {{-- <img src="{{ asset('public/storage/evamediaAPI') }}/${image}" alt=""> --}}
                        {{-- <img class="img-fluid mb-5" src="{{ asset('public/img/evamedia/') . $post->image }}"
                            alt=""> --}}
                        {{-- <p>
                            Did you know that Warren Buffett advises against using a schedule? That way, he argues, you just
                            do what’s most important at any given time.
                        </p>
                        <p>
                            Buffet is as celebrated as Elon Musk when it comes to a certain kind of success, but I’d be
                            willing to bet you’ve heard more about how to implement Musk’s five- minute interval schedule
                            than Buffet’s advice to avoid scheduling entirely.
                        </p>
                        <p>
                            The reason for that discrepancy is the same reason that 98% of productivity advice sounds the
                            same. It’s the reason so much of this advice is written by and for the same types of people who
                            have succeeded in the same types of industries. It’s also why this advice is counterproductive
                        ...
                        <p>
                            It’s a problem that’s hiding in plain sight, and it becomes visible as soon as we shift our
                            perspective a little. Consider:
                        </p>

                        <br>

                        <p>
                            Which do you think is easier to teach — how to break your day up into five- minute increments or
                            how to reproduce whatever is happening in Warren Buffet’s brain when he surveys a vast financial
                            empire and selects the most important thing to focus on in the next hour?
                        </p>

                        <br>

                        <p>
                            Yep, it’s the five-minute-increment thing.
                        </p>

                        <br>

                        <p>
                            I call this <i>teachability bias</i>, and I see its pernicious effects on my clients,
                            mentees,and students every day. It has created a kind of cultural tunnel vision around what it
                            means to work well that’s crushing our productivity, our creativity, and our spirits.
                        </p>

                        <br>

                        <p>
                            Let’s get out of the tunnel and into the light.
                        </p>

                        <br>

                        <h3 class="fw-bold" style="color: #242424">The World According to Teachability Bias</h3>

                        <br>

                        <p>
                            Imagine two people who both manage the Herculean task of cooking themselves delicious, healthy
                            dinners every week. Cook #1 uses a database of recipes, populates a shopping list, and then
                            cooks the meals on a schedule. Meanwhile, Cook #2 wanders around the grocery store without a
                            list, fills the cart with what looks good that week, and then cooks each day without recipes by
                            combining the ingredients at hand.
                        </p> --}}
            ...
            <div class="recomendation-area" id="recomendation-area">
                ...
                {{-- <div class="row">
                    <div class="col-md-1 offset-3">
                        <a href="#" class="recomendation-item">
                            <div class="card" style="width: 18rem;">
                                <img class="card-img-top"
                                    src="{{ asset('public/img/evamedia/evamedia-detail-banner.png') }}" alt="Card img">
                                <div class="card-body">
                                    <div class="card-profile d-flex gap-2 align-items-center mb-4">
                                        <img class="card-profile-icon"
                                            src="{{ asset('public/storage/evamediaAPI/avatar/e96FlrWGty.png') }}"
                                            alt="profile-icon">
                                        <p class="card-profile-name m-0">Desiree Peralta <span>in</span> Publishous</p>
                                    </div>
                                    <h3 class="card-title">
