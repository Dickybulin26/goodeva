...
@section('title', 'Goodeva - Evamedia')
{{-- Meta Section --}}
@section('meta_desc')
Wujudkan ide & mimpi dalam satu platform terintegrasi untuk membantu bisnis berkembang hebat bersama technology@endsection
@endsection
...
@section('css_after')
    ...
    <style>
        ...
        * span.odd {
        ...
        .evamedia-content .nav-trending .nav-item .nav-link:hover {
            border: 1px solid #fff;
            background: #26A7B5;
            color: #fff;
        }
...
@section('content')
    ...
    <!-- trending -->
    <section id="trending" class="trending section light-background">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 trending-area">
                    <ul class="nav-trending justify-content-center">
                        <li class="nav-item">
                            <a class="nav-link mr-3" href="#trending" data-tab="tabAll"><i class="fa fa-compass"></i> Explore
                                Topics</a>
                        </li>
                        <li class="nav-item active">
                            <a class="nav-link" href="#trending" data-tab="tabGov">Technology</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#trending" data-tab="tabCor">Artificial Intelligence</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#trending" data-tab="tabInt">Programming</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#trending" data-tab="tabInt">Tech</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#trending" data-tab="tabInt">Business</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#trending" data-tab="tabInt">Data Science</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#trending" data-tab="tabInt">Machine Learning</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#trending" data-tab="tabInt">Blockchain</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="other-feature-area desktop-show">
                <div class="other-feature-header d-flex align-items-center">
                    <img class="other-fitur-header-icon"
                        src="{{ $basePathPage . '/' . $text_lang[$default_lang]['section2']['icon'] }}"
                        alt="trending-icon">
                    <p class="other-feature-header-title m-0">{{ $text_lang[$default_lang]['section2']['title'] }}</p>
                </div>

                <div class="card-group row mx-0 mb-3" id="card-group-trending">

                    {{-- <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" id="card-item-trending">
                        <div class="other-feature-card row mx-0">
                            <div class="col-lg-2">
                                <h1 class="trending-number">
                                    ${i}
                                </h1>
                            </div>
                            <div class="col-lg-10">
                                <div class="trending-post-profile d-flex gap-2 mb-3">
                                    <img class="trending-profile-icon" src="${image}" alt="">
                                    <p class="trending-name m-0">
                                        ${author}
                                    </p>
                                </div>
                                <a href="#">
    ...
    {{-- evamedia content latest --}}
    <section id="evamedia-content" class="evamedia-content">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-md-12 col-sm-12 evamedia-content-area" id="evamedia-content-area">
                    {{-- <a href="#">
                                ...
                                <div class="col-lg-8">
                                    <div class="card-profile d-flex gap-2 align-items-center">
                                        <img class="card-profile-icon"
                                            src="{{ $basePathPage . '/' . $text_lang[$default_lang]['section3']['evamedia_content']['content1']['profile_icon'] }}"
                                            alt="profile-icon">
                                        <p class="card-profile-name m-0">Biz Stone</p>
                                    </div>
                                    <h5 class="card-title">
                                        {{ $text_lang[$default_lang]['section3']['evamedia_content']['content1']['title'] }}
                                    </h5>
                                    <p class="card-text">
                                        {{ $text_lang[$default_lang]['section3']['evamedia_content']['content1']['desc'] }}
                                    </p>
                                    <div class="card-info d-flex gap-4">
                                        <p class="card-date">
                                            {{ $text_lang[$default_lang]['section3']['evamedia_content']['content1']['date'] }}
                                        </p>
                                        <p class="card-category">
                                            {{ $text_lang[$default_lang]['section3']['evamedia_content']['content1']['category'] }}
                                        </p>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <img src="{{ $basePathPage . '/' . $text_lang[$default_lang]['section3']['evamedia_content']['content1']['image'] }}"
                                        class="img-card" alt="lkpp-goodeva-bg">
                                </div>
                            </div>
                        </div>
                    </a> --}}
                        ...
                        <div class="card py-0">
                            <div class="card-body row py-0">
                                <div class="col-lg-8">
                                    <div class="card-profile d-flex gap-2 align-items-center">
                                        <img class="card-profile-icon"
                                            src="{{ $basePathPage . '/' . $text_lang[$default_lang]['section3']['evamedia_content']['content2']['profile_icon'] }}"
                                            alt="profile-icon">
                                        <p class="card-profile-name m-0">Biz Stone</p>
                                    </div>
                                    <h5 class="card-title">
                                        {{ $text_lang[$default_lang]['section3']['evamedia_content']['content2']['title'] }}
                                    </h5>
                                    <p class="card-text">
                                        {{ $text_lang[$default_lang]['section3']['evamedia_content']['content2']['desc'] }}
                                    </p>
                                    <div class="card-info d-flex gap-4">
                                        <p class="card-date">
                                            {{ $text_lang[$default_lang]['section3']['evamedia_content']['content2']['date'] }}
                                        </p>
                                        <p class="card-category">
                                            {{ $text_lang[$default_lang]['section3']['evamedia_content']['content2']['category'] }}
                                        </p>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <img src="{{ $basePathPage . '/' . $text_lang[$default_lang]['section3']['evamedia_content']['content2']['image'] }}"
                                        class="img-card" alt="lkpp-goodeva-bg">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card py-0">
                            <div class="card-body row py-0">
                                <div class="col-lg-8">
                                    <div class="card-profile d-flex gap-2 align-items-center">
                                        <img class="card-profile-icon"
                                            src="{{ $basePathPage . '/' . $text_lang[$default_lang]['section3']['evamedia_content']['content3']['profile_icon'] }}"
                                            alt="profile-icon">
                                        <p class="card-profile-name m-0">Biz Stone</p>
                                    </div>
                                    <h5 class="card-title">
                                        {{ $text_lang[$default_lang]['section3']['evamedia_content']['content3']['title'] }}
                                    </h5>
                                    <p class="card-text">
                                        {{ $text_lang[$default_lang]['section3']['evamedia_content']['content3']['desc'] }}
                                    </p>
                                    <div class="card-info d-flex gap-4">
                                        <p class="card-date">
                                            {{ $text_lang[$default_lang]['section3']['evamedia_content']['content3']['date'] }}
                                        </p>
                                        <p class="card-category">
                                            {{ $text_lang[$default_lang]['section3']['evamedia_content']['content3']['category'] }}
                                        </p>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <img src="{{ $basePathPage . '/' . $text_lang[$default_lang]['section3']['evamedia_content']['content3']['image'] }}"
                                        class="img-card" alt="lkpp-goodeva-bg">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card py-0">
                            <div class="card-body row py-0">
                                <div class="col-lg-8">
                                    <div class="card-profile d-flex gap-2 align-items-center">
                                        <img class="card-profile-icon"
                                            src="{{ $basePathPage . '/' . $text_lang[$default_lang]['section3']['evamedia_content']['content4']['profile_icon'] }}"
                                            alt="profile-icon">
                                        <p class="card-profile-name m-0">Biz Stone</p>
                                    </div>
                                    <h5 class="card-title">
                                        {{ $text_lang[$default_lang]['section3']['evamedia_content']['content4']['title'] }}
                                    </h5>
                                    <p class="card-text">
                                        {{ $text_lang[$default_lang]['section3']['evamedia_content']['content4']['desc'] }}
                                    </p>
                                    <div class="card-info d-flex gap-4">
                                        <p class="card-date">
                                            {{ $text_lang[$default_lang]['section3']['evamedia_content']['content4']['date'] }}
                                        </p>
                                        <p class="card-category">
                                            {{ $text_lang[$default_lang]['section3']['evamedia_content']['content4']['category'] }}
                                        </p>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <img src="{{ $basePathPage . '/' . $text_lang[$default_lang]['section3']['evamedia_content']['content4']['image'] }}"
                                        class="img-card" alt="lkpp-goodeva-bg">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card py-0">
                            <div class="card-body row py-0">
                                <div class="col-lg-8">
                                    <div class="card-profile d-flex gap-2 align-items-center">
                                        <img class="card-profile-icon"
                                            src="{{ $basePathPage . '/' . $text_lang[$default_lang]['section3']['evamedia_content']['content5']['profile_icon'] }}"
                                            alt="profile-icon">
                                        <p class="card-profile-name m-0">Biz Stone</p>
                                    </div>
                                    <h5 class="card-title">
                                        {{ $text_lang[$default_lang]['section3']['evamedia_content']['content5']['title'] }}
                                    </h5>
                                    <p class="card-text">
                                        {{ $text_lang[$default_lang]['section3']['evamedia_content']['content5']['desc'] }}
                                    </p>
                                    <div class="card-info d-flex gap-4">
                                        <p class="card-date">
                                            {{ $text_lang[$default_lang]['section3']['evamedia_content']['content5']['date'] }}
                                        </p>
                                        <p class="card-category">
                                            {{ $text_lang[$default_lang]['section3']['evamedia_content']['content5']['category'] }}
                                        </p>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <img src="{{ $basePathPage . '/' . $text_lang[$default_lang]['section3']['evamedia_content']['content5']['image'] }}"
                                        class="img-card" alt="lkpp-goodeva-bg">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card py-0">
                            <div class="card-body row py-0">
                                <div class="col-lg-8">
                                    <div class="card-profile d-flex gap-2 align-items-center">
                                        <img class="card-profile-icon"
                                            src="{{ $basePathPage . '/' . $text_lang[$default_lang]['section3']['evamedia_content']['content6']['profile_icon'] }}"
                                            alt="profile-icon">
                                        <p class="card-profile-name m-0">Biz Stone</p>
                                    </div>
                                    <h5 class="card-title">
                                        {{ $text_lang[$default_lang]['section3']['evamedia_content']['content6']['title'] }}
                                    </h5>
                                    <p class="card-text">
                                        {{ $text_lang[$default_lang]['section3']['evamedia_content']['content6']['desc'] }}
                                    </p>
                                    <div class="card-info d-flex gap-4">
                                        <p class="card-date">
                                            {{ $text_lang[$default_lang]['section3']['evamedia_content']['content6']['date'] }}
                                        </p>
                                        <p class="card-category">
                                            {{ $text_lang[$default_lang]['section3']['evamedia_content']['content6']['category'] }}
                                        </p>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <img src="{{ $basePathPage . '/' . $text_lang[$default_lang]['section3']['evamedia_content']['content6']['image'] }}"
                                        class="img-card" alt="lkpp-goodeva-bg">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card py-0">
                            <div class="card-body row py-0">
                                <div class="col-lg-8">
                                    <div class="card-profile d-flex gap-2 align-items-center">
                                        <img class="card-profile-icon"
                                            src="{{ $basePathPage . '/' . $text_lang[$default_lang]['section3']['evamedia_content']['content7']['profile_icon'] }}"
                                            alt="profile-icon">
                                        <p class="card-profile-name m-0">Biz Stone</p>
                                    </div>
                                    <h5 class="card-title">
                                        {{ $text_lang[$default_lang]['section3']['evamedia_content']['content7']['title'] }}
                                    </h5>
                                    <p class="card-text">
                                        {{ $text_lang[$default_lang]['section3']['evamedia_content']['content7']['desc'] }}
                                    </p>
                                    <div class="card-info d-flex gap-4">
                                        <p class="card-date">
                                            {{ $text_lang[$default_lang]['section3']['evamedia_content']['content7']['date'] }}
                                        </p>
                                        <p class="card-category">
                                            {{ $text_lang[$default_lang]['section3']['evamedia_content']['content7']['category'] }}
                                        </p>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <img src="{{ $basePathPage . '/' . $text_lang[$default_lang]['section3']['evamedia_content']['content7']['image'] }}"
                                        class="img-card" alt="lkpp-goodeva-bg">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card py-0">
                            <div class="card-body row py-0">
                                <div class="col-lg-8">
                                    <div class="card-profile d-flex gap-2 align-items-center">
                                        <img class="card-profile-icon"
                                            src="{{ $basePathPage . '/' . $text_lang[$default_lang]['section3']['evamedia_content']['content8']['profile_icon'] }}"
                                            alt="profile-icon">
                                        <p class="card-profile-name m-0">Biz Stone</p>
                                    </div>
                                    <h5 class="card-title">
                                        {{ $text_lang[$default_lang]['section3']['evamedia_content']['content8']['title'] }}
                                    </h5>
                                    <p class="card-text">
                                        {{ $text_lang[$default_lang]['section3']['evamedia_content']['content8']['desc'] }}
                                    </p>
                                    <div class="card-info d-flex gap-4">
                                        <p class="card-date">
                                            {{ $text_lang[$default_lang]['section3']['evamedia_content']['content8']['date'] }}
                                        </p>
                                        <p class="card-category">
                                            {{ $text_lang[$default_lang]['section3']['evamedia_content']['content8']['category'] }}
                                        </p>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <img src="{{ $basePathPage . '/' . $text_lang[$default_lang]['section3']['evamedia_content']['content8']['image'] }}"
                                        class="img-card" alt="lkpp-goodeva-bg">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card py-0">
                            <div class="card-body row py-0">
                                <div class="col-lg-8">
                                    <div class="card-profile d-flex gap-2 align-items-center">
                                        <img class="card-profile-icon"
                                            src="{{ $basePathPage . '/' . $text_lang[$default_lang]['section3']['evamedia_content']['content9']['profile_icon'] }}"
                                            alt="profile-icon">
                                        <p class="card-profile-name m-0">Biz Stone</p>
                                    </div>
                                    <h5 class="card-title">
                                        {{ $text_lang[$default_lang]['section3']['evamedia_content']['content9']['title'] }}
                                    </h5>
                                    <p class="card-text">
                                        {{ $text_lang[$default_lang]['section3']['evamedia_content']['content9']['desc'] }}
                                    </p>
                                    <div class="card-info d-flex gap-4">
                                        <p class="card-date">
                                            {{ $text_lang[$default_lang]['section3']['evamedia_content']['content9']['date'] }}
                                        </p>
                                        <p class="card-category">
                                            {{ $text_lang[$default_lang]['section3']['evamedia_content']['content9']['category'] }}
                                        </p>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <img src="{{ $basePathPage . '/' . $text_lang[$default_lang]['section3']['evamedia_content']['content9']['image'] }}"
                                        class="img-card" alt="lkpp-goodeva-bg">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card py-0">
                            <div class="card-body row py-0">
                                <div class="col-lg-8">
                                    <div class="card-profile d-flex gap-2 align-items-center">
                                        <img class="card-profile-icon"
                                            src="{{ $basePathPage . '/' . $text_lang[$default_lang]['section3']['evamedia_content']['content10']['profile_icon'] }}"
                                            alt="profile-icon">
                                        <p class="card-profile-name m-0">Biz Stone</p>
                                    </div>
                                    <h5 class="card-title">
                                        {{ $text_lang[$default_lang]['section3']['evamedia_content']['content10']['title'] }}
                                    </h5>
                                    <p class="card-text">
                                        {{ $text_lang[$default_lang]['section3']['evamedia_content']['content10']['desc'] }}
                                    </p>
                                    <div class="card-info d-flex gap-4">
                                        <p class="card-date">
                                            {{ $text_lang[$default_lang]['section3']['evamedia_content']['content10']['date'] }}
                                        </p>
                                        <p class="card-category">
                                            {{ $text_lang[$default_lang]['section3']['evamedia_content']['content10']['category'] }}
                                        </p>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <img src="{{ $basePathPage . '/' . $text_lang[$default_lang]['section3']['evamedia_content']['content10']['image'] }}"
                                        class="img-card" alt="lkpp-goodeva-bg">
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12">
                    <div class="category-header">
                        <h2 class="category-title">Discover more of what matters to you</h2>
                    </div>
                    <ul class="nav-trending justify-content-center">
                        <li class="nav-item">
                            <a class="nav-link" href="#evamedia-content" data-tab="Programming" data-value="1">Programming</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#evamedia-content" data-tab="Data Science" data-value="2">Data Science</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#evamedia-content" data-tab="Technology" data-value="6">Technology</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#evamedia-content" data-tab="Self Improvement" data-value="8">Self
                                Improvement</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#evamedia-content" data-tab="Writing" data-value="7">Writing</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#evamedia-content" data-tab="Relationships" data-value="9">Relationships</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#evamedia-content" data-tab="Machine Learning" data-value="4">Machine
                                Learning</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#evamedia-content" data-tab="Productivity" data-value="5">Productivity</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#evamedia-content" data-tab="Politics" data-value="3">Politics</a>
                        </li>
                    </ul>
...
@section('js_after')
    <script>
        ...
        $(document).ready(function() {
            $.ajax({
                type: "GET",
                url: "{{ url('/api/trending') }}",
                data: {},
                success: function(data) {
                    let cardGroup = $('#card-group-trending');
                    cardGroup.empty();
                    console.log(data);

                    data.data.forEach((post, index) => {
                        let cardHtml = $('#card-template-trending').html();

                        // memberi no post dengan looping
                        const postNumber = index + 1;

                        cardHtml = cardHtml.replace('${postNumber}', postNumber);
                        cardHtml = cardHtml.replace('${slug}', post.slug);
                        cardHtml = cardHtml.replace('${publisher}', post.publisher);
                        cardHtml = cardHtml.replace('${author}', post.authors.name);
                        cardHtml = cardHtml.replace('${avatarTrending}', post.authors.avatar);
        ...
        $(document).ready(function() {
            $.ajax({
                type: "GET",
                url: "{{ route('post.latest') }}",
                data: {},
                success: function(data) {
                    let cardGroup = $('#evamedia-content-area');
                    cardGroup.empty();
                    console.log(data);

                    data.data.forEach(post => {
                        let cardHtml = $('#card-template-latest').html();

                        cardHtml = cardHtml.replace('${id}', post.id);
                        cardHtml = cardHtml.replace('${slug}', post.slug);
                        cardHtml = cardHtml.replace('${author}', post.authors.name);
                        cardHtml = cardHtml.replace('${publisher}', `in ${post.publisher}`);
                        cardHtml = cardHtml.replace('${avatarLatest}', post.authors.avatar);
                        cardHtml = cardHtml.replace('${title}', post.title);
                        cardHtml = cardHtml.replace('${news_content}', post.news_content);
                        cardHtml = cardHtml.replace('${image}', post.image);
                        cardHtml = cardHtml.replace('${timediff}', post.timediff);
        ...
        // menampilkan postingan berdasarkan button cattegory
    ...
    {{-- template trending --}}
    <script id="card-template-trending" type="text/template">
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" id="card-item-trending">
            <div class="other-feature-card row mx-0">
                <div class="col-lg-2">
                    <h1 class="trending-number">
                ...
                <div class="col-lg-10">
                    <div class="trending-post-profile d-flex gap-2 mb-3">
                        <img class="trending-profile-icon" src="{{ asset('public/storage/evamediaAPI/avatar')}}/${avatarTrending}" alt="">
                        <p class="trending-name m-0">
                            ${author}
                        </p>
                    </div>
                    <a href="{{ url('evamedia/read') }}/${slug}">
                        <p class="trending-title">
                            ${title}
                        </p>
                    </a>
    ...
    {{-- template latest --}}
    <script id="card-template-latest" type="text/template">
        <a href="{{ url('evamedia/read') }}/${slug}">
            <div class="card py-0 mt-0">
                <div class="card-body row py-0">
                    <div class="col-lg-8">
                        <div class="card-profile d-flex gap-2 align-items-center">
                            <img class="card-profile-icon"
                                src="{{ asset('public/storage/evamediaAPI/avatar')}}/${avatarLatest}"
                                alt="profile-icon">
                    ...
                    <div class="col-lg-4">
                        <img src="{{ asset('public/storage/evamediaAPI' ) }}/${image}"
                            class="img-card" alt="Card image">
                    </div>
                </div>
            </div>
        </a>
