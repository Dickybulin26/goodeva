...
@section('css_after')
    @php
        $basePathPage = asset('public/img/detail-products/b20');
        ...
        <div class="container">
            <div class="desktop-show">
                <div class="card bg-dark text-white">
                    <img src="{{ $basePathPage . '/b20-indonesia.png' }}" class="card-img" alt="" />
                    <div class="card-img-overlay card-body">
                        <img src="{{ asset('public/img/goodeva-enterprise/b20-goodeva-logo.svg') }}" alt=""
                            class="card-logo" />
                        <h2 class="font-inter card-title">B20 Council Platform</h2>
                    ...
                    <div class="col-md-3">
                        <div class="side-content">
                            <div class="client-side mb-2">
                                ...
                                <img src="{{ $basePathPage . '/b20-goodeva-logo-color.png' }}" alt="B20 Logo" />
                            </div>
                    ...
                    <div class="col-md-9 col-xs-12 content">
                        ...
                        <div class="topic-paragraph problem-text" id="problemParagraph">
                            ...
                            <p class="font-inter">
                                ...
                                members also demands solid multilingual support to ensure all
                        ...
                        <div class="topic-paragraph solution-text" id="solutionParagraph">
                            ...
                            <img class="content-img" src="{{ $basePathPage . '/b20-image-1.png' }}" alt="" />
                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    <img class="client-img" src="{{ $basePathPage . '/b20-goodeva-logo-color.png' }}"
                                        alt="" />
                                </div>
                                <div class="col-md-10">
                                    <p class="font-inter">
                                    <h3>Council Platform Untuk B20</h3>
