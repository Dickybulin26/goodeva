...
@section('css_after')
    @php
        $basePathPage = asset('public/img/detail-products/undp');
        ...
        <div class="container">
            <div class="desktop-show">
                <div class="card bg-dark text-white">
                    <img src="{{ $basePathPage . '/undp.png' }}" class="card-img" alt="" />
                    <div class="card-img-overlay card-body">
                        <img src="{{ $basePathPage . '/undp-logo.png' }}" alt="" class="card-logo" />
                        <h2 class="font-inter card-title">UNDP</h2>
                        <p class="font-inter card-text">
                            This system will integrate data from various sources into an easily accessible and analyzable
                            platform.
                        </p>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="side-content">
                            <div class="client-side mb-2">
                                ...
                                <img src="{{ $basePathPage . '/undp-logo.png' }}" alt="B20 Logo" />
                            </div>
                    ...
                    <div class="col-md-9 col-xs-12 content">
                        <div class="content-title">
                            <h2>
                                Goodeva Enterprise proudly introduces the UNDP portal, a web-based platform for monitoring
                        ...
                        <div class="topic-paragraph problem-text" id="problemParagraph">
                            ...
                            <p>
                                UNDP (United Nations Development Programme) faces challenges in monitoring
                                and assessing sustainable palm oil farming practices in developing countries.
                                Currently, the lack of an integrated portal-based system hinders UNDP's ability to
                                collect, manage, and analyze data from various locations in real-time.
                            </p>
                            <p>
                                Without this system, it is difficult to ensure that the agricultural practices being
                                carried out meet sustainability standards and to identify areas that require
                                improvement. The lack of accurate and centralized data complicates UNDP's
                                ability to provide appropriate recommendations and support effective policies to
                                enhance environmentally friendly palm oil farming practices.
                        ...
                        <div class="topic-paragraph solution-text" id="solutionParagraph">
                            ...
                            <p>
                                To address this challenge, UNDP needs to implement an advanced web-based
                                monitoring and evaluation system. This system will integrate data from various
                                sources into a platform that is easy to access and analyze.
                            </p>
                            <p>
                                With this web-based system, UNDP can monitor land use, soil conditions, biodiversity, and
                                cultivation practices in real-time.
                            </p>

                            <img class="content-img" src="{{ $basePathPage . '/undp-content.png' }}" alt="" />

                            <p>
                                With advanced technology and real-time analysis, the UNDP portal helps ensure sustainability
                                and efficiency at every stage of production.
                            </p>
                            <h3 id="productParagraph">Product</h3>
                            <div class="row">
                                <div class="col-md-2">
                                    <img class="client-img" src="{{ $basePathPage . '/undp-logo.png' }}" alt="" />
                                </div>
                                <div class="col-md-10">
                                    <h3 class="m-0">Portal UNDP</h3>
                                    <p>
                                        A web-based platform to monitor and assess palm oil farming practices.
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-9 col-xs-12 content">
                        ...
                        <div class="topic-paragraph solution-text" id="solutionParagraphMobile">
                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    <img class="client-img" src="{{ $basePathPage . '/undp-logo.png' }}"
                                        alt="" />
                                </div>
                                <div class="col-md-10">
                                    <h3 class="m-0">Portal UNDP</h3>
