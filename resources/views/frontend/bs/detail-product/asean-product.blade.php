...
@section('css_after')
    @php
        $basePathPage = asset('public/img/detail-products/asean');
        ...
        <div class="container">
            <div class="desktop-show">
                <div class="card bg-dark text-white">
                    <img src="{{ $basePathPage . '/asean.png' }}" class="card-img" alt="" />
                    <div class="card-img-overlay card-body">
                        <img src="{{ $basePathPage . '/asean-goodeva.png' }}" alt="" class="card-logo" />
                        <h2 class="font-inter card-title">ASEAN</h2>
                        <p class="font-inter card-text">
                            The development and implementation of a self-hosted LMS that can be accessed by all member
                            countries. </p>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="side-content">
                            <div class="client-side mb-2">
                                ...
                                <img src="{{ $basePathPage . '/asean-logo.png' }}" alt="Asean Logo" />
                            </div>
                    ...
                    <div class="col-md-9 col-xs-12 content">
                        <div class="content-title">
                            <h2 class="font-inter">
                                Goodeva Enterprise proudly introduces an LMS product specifically designed for ASEAN.
                            </h2>
                        ...
                        <div class="topic-paragraph problem-text" id="problemParagraph">
                            ...
                            <p>
                                ASEAN faces challenges in disseminating information related to the Emergency
                                Operations Center (EOC) Network to its member countries due to the lack of an
                                independent Learning Management System (LMS).
                            </p>
                            <p>
                                Currently, ASEAN relies on external platforms and traditional methods for
                                socialization, which often prove to be less effective in reaching all stakeholders in
                                each member country. This limitation leads to an information gap and slow
                                coordination, hindering collective efforts to respond to emergency situations
                                efficiently and cohesively in the region.
                            </p>
                        </div>
                        <div class="topic-paragraph solution-text" id="solutionParagraph">
                            <h3 class="font-inter">Solution</h3>
                            <p>
                                To address this issue, ASEAN needs to develop and implement an independent
                                LMS that can be accessed by all member countries. This system will enable faster
                                and more equitable information dissemination, as well as provide a platform for
                                standardized training and simulations related to the EOC Network.
                            </p>
                            <p>
                                With a self-directed LMS, ASEAN can ensure that all members have access to
                                consistent and up-to-date socialization materials, as well as facilitate more
                                effective discussions and collaborations among member countries. This
                                implementation will enhance ASEAN's readiness and response capabilities to
                                emergency situations, while also strengthening regional solidarity and
                                cooperation.
                            </p>

                            <img class="content-img" src="{{ $basePathPage . '/asean-content.png' }}" alt="" />

                            <p>
                                With advanced features and easy accessibility, our LMS ensures that every
                                ASEAN member country can access vital information and training efficiently and
                                in a standardized manner.
                            </p>
                            <h3 id="productParagraph">Product</h3>
                            <div class="row">
                                <div class="col-md-5">
                                    <img class="client-img" src="{{ $basePathPage . '/asean-elearn-logo.png' }}"
                                        alt="" />
                                </div>
                                <div class="col-md-7">
                                    <h3 class="m-0">LMS ASEAN PHE</h3>
                                    <p>
                                        An innovative self-learning platform. </p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="side-content">
                            <div class="client-side mb-2">
                                <h4 class="font-inter">Client</h4>
                                <img src="{{ $basePathPage . '/asean-logo.png' }}" alt="B20 Logo" />
                            </div>
                            <div class="field-side mb-2">
                                <h4 class="font-inter">Field</h4>
                                <p>Global Organization</p>
                        ...
                        <div class="topic-paragraph solution-text" id="solutionParagraphMobile">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-7">
                                    <h3 class="m-0">LMS ASEAN PHE</h3>
                                    <p>
                                        An innovative self-learning platform.
                                    </p>
                                </div>
                            </div>
                        </div>
