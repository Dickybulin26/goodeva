...
@section('css_after')
    @php
        $basePathPage = asset('public/img/detail-products/pertanian');
        ...
        <div class="container">
            <div class="desktop-show">
                <div class="card bg-dark text-white">
                    <img src="{{ $basePathPage . '/pertanian.png' }}" class="card-img" alt="" />
                    <div class="card-img-overlay card-body">
                        <img src="{{ $basePathPage . '/pertanian-icon.png' }}" alt="" class="card-logo" />
                        <h2 class="font-inter card-title">Kementrian Pertanian</h2>
                        <p class="font-inter card-text">
                            A web platform specifically for monitoring palm oil to integrate data from various sources for
                            easy access.
                        </p>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="side-content">
                            <div class="client-side mb-2">
                                ...
                                <img src="{{ $basePathPage . '/pertanian-logo.png' }}" alt="B20 Logo" />
                            </div>
                    ...
                    <div class="col-md-9 col-xs-12 content">
                        <div class="content-title">
                            <h2>
                                Goodeva Enterprise proposes a solution in the form of developing a web platform specifically
                                for monitoring palm oil.
                            </h2>
                        ...
                        <div class="topic-paragraph problem-text" id="problemParagraph">
                            ...
                            <p>
                                Indonesia is the largest producer of palm oil in the world, yet the management of
                                palm oil plantations still faces various challenges. The Ministry of Agriculture
                                does not have specific monitoring tools for palm oil, which results in various
                                issues such as unintegrated data recording, lack of transparency, and decision making that
                                is not based on real-time data.
                            </p>
                            <p>
                                This causes difficulties in monitoring agricultural practices, pest and disease
                                control, as well as responding to changes in weather conditions. The absence of
                                this specific monitoring tool has rendered oversight of palm oil ineffective.
                            </p>
                            <p>
                                The scattered and unintegrated data makes it difficult for the Ministry of
                                Agriculture to obtain an accurate picture of the condition of palm oil plantations.
                                Furthermore, without real-time data, strategic decision-making becomes
                                suboptimal, and responses to field issues are slow.
                            </p>
                        </div>
                        <div class="topic-paragraph solution-text" id="solutionParagraph">
                            <h3 class="font-inter">Solution</h3>
                            <p>
                                Goodeva Enterprise proposes a solution in the form of developing a web
                                platform specifically for monitoring palm oil to integrate data from various
                                sources, making it easily accessible and analyzable, and providing a real-time
                                data view regarding land area, plant conditions, and production in one place.
                            </p>
                            <p>
                                The implementation of this solution will begin with an analysis of the specific
                                needs of the Ministry of Agriculture. Goodeva Enterprise will develop a platform
                                with a user-friendly interface design and the necessary features. After that, trials
                                will be conducted at several pilot locations, accompanied by training for users.
                                The official launch will be followed by regular evaluations to ensure the platform
                                functions as expected.
                            </p>

                            <img class="content-img" src="{{ $basePathPage . '/pertanian-content.png' }}" alt="" />

                            <p>
                                With this platform, it is hoped that the Ministry of Agriculture can improve
                                operational efficiency and transparency in the management of palm oil
                                plantations. Real-time data will support faster and more accurate decision making, while
                                early warning systems will enable quick responses to issues.
                                Overall, the productivity of oil palm plantations can be improved, supporting
                                better national economic growth.
                            </p>
                            <h3 id="productParagraph">Product</h3>
                            <div class="row">
                                <div class="col-md-2">
                                    <img class="client-img" src="{{ $basePathPage . '/pertanian-icon.png' }}"
                                        alt="" />
                                </div>
                                <div class="col-md-10">
                                    <h3 class="m-0">Platform RANKSB</h3>
                                    <p>
                                        A web-based system specifically designed to assist in the monitoring and management of oil palm plantations
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-9 col-xs-12 content">
                        ...
                        <div class="topic-paragraph solution-text" id="solutionParagraphMobile">
                            ...
                            <img class="content-img" src="{{ $basePathPage . '/pertanian-content.png' }}"
                                alt="" />
