...
@section('title', 'Goodeva Sales Trace - Sales Trace Membantu Resi Penjualan')
{{-- Meta Section --}}
@section('meta_desc')
...
@section('css_after')
    @php
        $basePathPage = asset('public/img/salestrace');
...
@section('content')
            ...
            <div class="hero-slider" id="hero-slider">
                <div class="hero-slider-content">
                    <img src="{{ $basePathPage . '/background-hero.png' }}" class="d-block w-100 main-image"
                        alt="">
                    <img src="{{ $basePathPage . '/banner-item-sales-trace.png' }}" class="left-slider-item"
                        alt="">
        ...
        <div class="hero-slider-area mobile-show mt-0">
            <div class="hero-slider" id="hero-slider-mobile">
                <div class="hero-slider-content">
                    <img src="{{ $basePathPage . '/background-hero.png' }}" class="d-block w-100 main-image"
                        alt="">
                    <img src="{{ $basePathPage . '/banner-item-sales-trace-m.png' }}" class="left-slider-item"
                        alt="">
                    <div class="text-hero-banner">
                        <span class="font-inter">{{ $text_lang[$default_lang]['section1']['name_product'] }}</span>
                        <h2 class="font-inter">
        ...
        <div class="container">
            <div class="partner-header">
                ...
                <div class="mobile-show">
                    <p class="font-inter partner-header-title">Portfolio and Client</p>
                </div>
            </div>
            <div class="partner-area">
                <div class="card-group row mx-0">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <img class="desktop-show" src="{{ $basePathPage . '/sales-trace-client.svg' }}" alt="">
                        <img class="mobile-show" src="{{ $basePathPage . '/sales-trace-client-m.svg' }}" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="define" class="define section light-background">
        ...
        <div class="mobile-show">
            <div class="container">
                <div class="title-service text-center fw-bold">
                    <div class="row">
                        <div class="col-md-7">
                            <h2>
            ...
            <div class="card-feature-area" id="card-feature-area">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="main-feature-content">
                            <h4 class="main-feature-title">
                                {{ $text_lang[$default_lang]['section7']['feature_product']['content4']['main_text'] }}
                            </h4>
                            <a href="#" class="read-more" type="button" data-bs-toggle="modal"
                                data-bs-target="#Modal4">Read More>></a>
                        </div>
                    </div>
                    <img class="card-img-bottom img-section"
                        src="{{ $basePathPage . '/' . $text_lang[$default_lang]['section7']['feature_product']['content4']['cover_m'] }}"
                        alt="Card img">
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="main-feature-content">
                            <h4 class="main-feature-title">
                                {{ $text_lang[$default_lang]['section7']['feature_product']['content5']['main_text'] }}
                            </h4>
                            <a href="#" class="read-more" type="button" data-bs-toggle="modal"
                                data-bs-target="#Modal5">Read More>></a>
                        </div>
                    </div>
                    <img class="card-img-bottom img-section"
                        src="{{ $basePathPage . '/' . $text_lang[$default_lang]['section7']['feature_product']['content5']['cover_m'] }}"
                        alt="Card img">
                </div>
    ...
    <section id="why" class="why section light-background">
        ...
        <div class="mobile-show">
            ...
            <div class="row mx-0">
                ...
                <div class="col-lg-6 col-md-6 pl-xl-why py-2">
                    <div class="why-content">
                        <h4 class="why-title font-inter">
                            {{ $text_lang[$default_lang]['section8']['main_text'] }}</h4>
                        <p class="why-desc font-inter">
