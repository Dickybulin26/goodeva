...
@section('css_after')
    ...
    <style>
        ...
        .header .navbar .navbar-nav > li:hover a, .header .navbar .navbar-nav > li:hover a > i {

            color: #ffffff !important;

        }

        .header .navbar .navbar-collapse .navbar-nav  > li > a:hover,.header .navbar .navbar-collapse .navbar-nav  > li:hover a > i{
        ...
        @media (max-width:361px)
        {
            ...
            .solusi .row-iot h4, .solusi .row-robotic h4, .solusi .row-data h4 {
                line-height: 2rem;
                font-size: 26px;
            }
...
@section('content')
                ...
                <div class="col-md-12 text-center" data-aos="fade-up" data-aos-delay="0" data-aos-once="true" data-aos-duration="1500">
                    ...
                    <div class="content-title">
                        ...
                        {{-- <figure>
                            ...
                            <span><img src="{{ asset('public/img/assets/light-logo.png') }}" class="lights" alt="image light"></span>

                        </figure> --}}

                        <img src="{{asset('public/img/assets/solution/goodeva-logo-white-lights.png')}}" alt="" class="mb-5 mb-sm-0">

                        {{-- <img src="{{asset('public/img/assets/solution/g logo@2x.png')}}" alt="" class="mobile-show"> --}}

                        <h2>

                            <span>Build <strong>Better Products</strong> With <strong>Goodeva</strong></span>

                        </h2>

                    </div>

                    <p class="mt-1 desktop-show">Goodeva adalah perusahaan Ai & iOT technology yang merencanakan dan mengembangkan aplikasi iOs, <br class="tablet-none"> Android, dan system web-base dengan menggabungkan teknologi dan data untuk mengubah ide menjadi sebuah kenyataan.</p>
                    <p class="mt-1 mobile-show">Goodeva adalah perusahaan Ai & iOT technology yang merencanakan dan mengembangkan aplikasi iOs, Android, dan system web-base dengan menggabungkan teknologi dan data untuk mengubah ide menjadi sebuah kenyataan.</p>
    ...
    <section class="solusi mt-10 desktop-show" id="solusi">
        ...
        <div class="container">
            ...
            <div class="header text-center">
                ...
                <h3 class="mt-5 mb-2">Solusi Tepat Untuk Bisnis Anda</h3>

                <p>Temukan solusi - solusi yang akan membantu bisnis anda berkembang dengan hebat Bersama Goodeva Technology.</p>
            ...
            <section class="section-1 wrap">
                ...
                <div class="row row-iot mt-5" data-aos="fade-up" data-aos-delay="300" data-aos-once="true" data-aos-duration="1500">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 pl-5 pr-0 box">
                        ...
                        <h4 class="mt-center">iOT with Artificial Intelligence</h4>

                        <p>Technology masa depan untuk integrasikan seluruh data yang diperoleh dari device kemudian diolah dengan Ai dan ditampilkan pada sebuah platform terintegrasi.</p>
            ...
            <div class="row row-android mt-5" data-aos="fade-up" data-aos-once="true" data-aos-duration="1500" data-aos-delay="800">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12 pl-5 pr-0">
                    ...
                    <h4 class="mt-center">Android & iOS development</h4>

                    <p>Wujudkan ide menjadi sebuah kenyataan dengan platform aplikasi berbasis android dan ios yang powerfull, customized, & sesuai dengan kebutuhan bisnis Anda.</p>
            ...
            <div class="container">
                ...
                <section class="wrap">
                    ...
                    <div class="row bg-abu row-robotic mt-5" data-aos="fade-up" data-aos-once="true" data-aos-duration="1000">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 pl-5 pr-0 box">
                            ...
                            <h4 class="mt-center">Robotic Process Automation</h4>

                            <p>Robotic proses untuk mengubah system konvensional menjadi lebih cepat dan efisien dengan teknologi system robotic yang otomatis.</p>
                ...
                <div class="row bg-abu row-data mt-5" data-aos="fade-up" data-aos-once="true" data-aos-duration="1000">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 pl-5 pr-0">
                        ...
                        <h4 class="mt-center">Data Management</h4>

                        <p>Kelola data untuk membuat keputusan yang lebih baik berdasarkan data dan informasi yang valid untuk kembangkan bisnis jadi lebih optimal.</p>
    ...
    <section class="solusi mt-5 mobile-show" id="solusi">
        ...
        <div class="container">
            ...
            <div class="header text-center">
                ...
                <h3 class="mt-0 mb-2">Solusi Tepat Untuk Bisnis Anda</h3>
    ...
    <section class="section-compannies portfolio" id="portfolio">
        ...
        <div class="container-custom">
            ...
            <div class="row mx-0  desktop-show">
                ...
                <div class="col-lg-12 col-md-12">
                    ...
                    <img class="img-responsive " src="{{asset('public/img/assets/home/goodeva-portfolio-client.png')}}" alt="">
            ...
            <div class="row mx-0 mb-50p mobile-show">
                ...
                <div class="col-lg-12 col-md-12">
                    ...
                    <img class="img-responsive " src="{{asset('public/img/assets/home/goodeva-portfolio-client-m.png')}}" alt="">
    ...
    <section id="ts-footer">
        ...
        <div class="container">
            ...
            <div class="ts-box mb-0 py-5 px-5 ts-mt__n-10 px-rem1 contact px-rem1 box-quest mx-auto" data-animate="ts-fadeInUp">
                ...
                <h5 class="my-0 ml-2">Ada Pertanyaan Lainnya?</h5>

                <p class="mt-2 ml-2 desktop-show">Punya ide untuk inovasi untuk digitalisasi bisnis lebih efektif & lebih efisien <br class="tablet-none"> bersama goodeva mari bersama kembangan bisnis anda.</p>

                <p class="mt-2 ml-2 mobile-show">Punya ide untuk inovasi untuk digitalisasi bisnis lebih efektif & lebih efisien bersama goodeva mari bersama kembangan bisnis anda.</p>
                            ...
                            <div class="row mb-0">
                                <div class="col-md-12 col-xs-12">
                                    <div class="input-field col s12 desktop-show">
                                        <button class="btn btn--kirim" id="kirim_pesan" type="button">Kirim Pesan</button>
                                    </div>
                                    <div class="mobile-show">
                                        <a href="{{ url('contact') }}">
                                            <button class="btn btn--kirim col-xs-12" id="kirim_pesan" type="button">Kirim Pesan</button>
                                        </a>
                                    </div>
                                </div>
                            </div>

                            {{-- <div class="input-field mb-0 mobile-show">
                                <div class="row mx-0 mb-0 ">

                                    <button class="btn btn--kirim col-xs-12 col-sm-12" type="submit">Kirim Pesan</button>
                                </div>
