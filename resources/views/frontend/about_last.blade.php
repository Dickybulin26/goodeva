...
<!-- Section comment -->
<section class="section-comments pb-0 desktop-show" style="padding-top: 135px;" >
...
<section class="section-comments bg-navy py-5  competency-comp mobile-show">
    ...
    {{-- <div class="container"> --}}
        ...
        <div class="row mx-0">
            ...
            <div class="col-md-6 col-xs-12 mt-50-">
...
<section class="section-comments pb-0 pt-0">
    ...
    <div class="container">
        ...
        <div class="row my-5" id="konten">

            <div class="col-md-4 col-sm-4 col-xs-12 p-3">

                <img src="{{ asset('public/img/assets/about/goodeva-gallery-1.png') }}"  alt="" class="b-radius10px">

            </div>

            <div class="col-md-4 col-sm-4 col-xs-12 p-3">

                <img src="{{ asset('public/img/assets/about/goodeva-gallery-2.png') }}"  alt="" class="b-radius10px">

            </div>

            <div class="col-md-4 col-sm-4 col-xs-12 p-3">

                <img src="{{ asset('public/img/assets/about/goodeva-gallery-3.png') }}"  alt="" class="b-radius10px">
