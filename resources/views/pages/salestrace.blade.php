    ...
    <main id="main">
            ...
            <div class="container">
                ...
                <div class="card-deck">
                    <div class="card first-card">
                        <img src="../assets/img/salestrace/card-benefit1.png" class="card-img-top main-card"
                            alt="api" />
            ...
            <div class="container">
                <div class="title-service text-center fw-bold pt-2">
                    ...
                    <div class="card mobile-redmi w-100">
                        <img src="../assets/img/salestrace/card-benefit1.png" class="card-img-top mobile"
                            alt="card-benefit">
                        <div class="card-body"
        ...
        <section id="salestrace-feature2" class="salestrace-feature2">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <img class="product-img img-fluid" src="../assets/img/salestrace/monitor-sales.png"
                            alt="" />
                    </div>
                    <div class="col-md-6 pt-4 pt-lg-0 text-container">
        ...
        <section id="salestrace-feature3" class="salestrace-feature3">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 pt-4 pt-lg-0 text-container">
                        <img class="product-img img-fluid" src="../assets/img/salestrace/sales-view.png"
                            alt="SalesTrace" />
                    </div>
                </div>
            </div>
        ...
        <section id="salestrace-feature4" class="salestrace-feature4">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <img class="product-img img-fluid" src="../assets/img/salestrace/all-in-one.png"
                            alt="" />
                    </div>
                    <div class="col-md-6 pt-4 pt-lg-0 text-container">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <div class="col-lg-6 col-sm-10">
                                <img src="../assets/img/salestrace/carousel-benifit1.png" class="d-block"
                                    alt="" />
